...
if "%PEGA_TOOL%"=="appConfig" goto :pegaToolOK
...
:PrintUsage
echo usage:
echo prpcserviceutils.bat ( expose ^| export ^| hotfix ^| getStatus ^| import ^| manageTrackedData ^| rollback ^| manageRestorePoints ^| updateAccessGroup ^| appConfig ^| help ) [options...]
echo.
echo Options:
